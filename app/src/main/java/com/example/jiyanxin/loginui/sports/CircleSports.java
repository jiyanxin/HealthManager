...
/**
 * Created by JIYANXIN on 2017/4/11.
 */

public class CircleSports extends View {
    //边框宽度
     ...
     * 进度条最大值和当前进度值
     */
    private float max=10000, progress=5000;
    public int text;
    ...
    public CircleSports(Context context) {
        super(context);
        init();
    }

    public CircleSports(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CircleSports(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("步", centerX + w1 / 2 - extraW + 5, centerY - (h1 / 2 - h2), textPaint);
